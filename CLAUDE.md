...
src/
  ...
  App.tsx               # Save/Load buttons, Cmd+S/Cmd+Z/Cmd+Shift+Z/Cmd+D/Cmd+G shortcuts, help pane, grid controls (with axes toggle), camera preset buttons, selectedIds/selectedAssemblyId state, eyedropper state, AssemblyPanel or PartPanel (conditionally), PartsList, Canvas
  components/
